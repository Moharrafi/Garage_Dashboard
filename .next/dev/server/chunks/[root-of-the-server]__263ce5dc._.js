...
async function createNotification(fields) {
    ...
    const id = __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].randomUUID();
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO ${NOTIFICATION_TABLE} (id, profile_id, title, message, type, is_read)
     VALUES (?, ?, ?, ?, ?, ?)`, [
        id,
        fields.profile_id,
        fields.title,
    ...
    const [row] = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT * FROM ${NOTIFICATION_TABLE} WHERE id = ?`, [
        id
    ]);
...
async function getNotifications() {
    ...
    const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT * FROM ${NOTIFICATION_TABLE} WHERE profile_id = ? ORDER BY created_at DESC`, [
        profile.id
    ]);
...
async function markNotificationRead(id, read) {
    await ensureNotificationsTable();
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE ${NOTIFICATION_TABLE} SET is_read = ?, updated_at = NOW() WHERE id = ?`, [
        read ? 1 : 0,
        id
    ]);
}
async function deleteNotification(id) {
    await ensureNotificationsTable();
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`DELETE FROM ${NOTIFICATION_TABLE} WHERE id = ?`, [
        id
    ]);
}
async function deleteAllNotifications(profileId) {
    await ensureNotificationsTable();
    const profile = profileId ? {
        id: profileId
    } : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$profile$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrCreateAdminProfile"])();
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`DELETE FROM ${NOTIFICATION_TABLE} WHERE profile_id = ?`, [
        profile.id
    ]);
}
async function markAllNotificationsRead(profileId) {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE ${NOTIFICATION_TABLE} SET is_read = 1 WHERE profile_id = ?`, [
        profile.id
    ]);
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__263ce5dc._.js.map